...
public class viewtransaction extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        li2=findViewById(R.id.lv);

        sh = PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
        ip = sh.getString("url", "");
        url = ip + "/andtransaction";
                        ...
                        try {
                            ...
                            if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                ...
                                for (int i = 0; i < js.length(); i++) {
                                    ...
                                    type[i] = u.getString("type(credit,debit)");
                                ...
                                li2.setAdapter(new custom_view_transaction(getApplicationContext(),time,date,amount,type,description));//custom_view_service.xml and li is the listview object
