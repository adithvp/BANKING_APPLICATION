...
public class viewreplay extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        li3 = (ListView) findViewById(R.id.list);
...
//                                    cid[i] = u.getString("complaint_id");//dbcolumn name in double quotes
                                    ...
                                    rdate[i] = u.getString("replay_date");


                                }
                                li3.setAdapter(new customerviewrply(getApplicationContext(), com, cdate, reply, rdate));//custom_view_service.xml and li is the listview object
