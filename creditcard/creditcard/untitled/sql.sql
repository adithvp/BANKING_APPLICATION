...
insert  into `login`(`login_id`,`user_name`,`password`,`user_type`) values (1,'admin','admin','admin'),(2,'branch','branch','branch'),(3,'sss','2767','customer'),(4,'sayoojkrishnajr100@gmail.com','6146','customer'),(5,'abhi','3236','customer'),(6,'  abhinnandu135@gmail.com','3928','customer'),(7,'atm','atm','atm');
...
insert  into `otp`(`o_id`,`c_id`,`otp`,`status`) values (1,4,'8976','pending');
